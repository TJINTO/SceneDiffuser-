...
def build_fidelity_audit() -> tuple[FidelityEntry, ...]:
    return (
        _entry(
            ...
            "intentional_deviation",
            "src/scenediffuserpp/sumo_export.py",
            "src/scenediffuserpp/scene_builder.py",
        ),
        _entry(
            "frequency_horizon",
            "Data",
            ...
            "src/scenediffuserpp/schema.py:SceneSpec",
        ),
        _entry(
            "agent_capacity",
            "Scale",
        ...
        _entry(
            ...
            "reduced_scale",
            "configs/scenediffuserpp/data_nanjing_10hz.yaml",
            "src/scenediffuserpp/schema.py:SceneSpec.small",
        ...
        _entry(
            ...
            "interpreted",
            "src/scenediffuserpp/context_encoder.py:RoadgraphEncoder",
        ),
        _entry(
            "conditioning_fusion",
            "Architecture",
            ...
            "interpreted",
            "src/scenediffuserpp/multi_tensor_model.py:MultiTensorDenoiser",
        ...
        _entry(
            ...
            "interpreted",
            "src/scenediffuserpp/axial_transformer.py:AxialTransformerBlock",
            "src/scenediffuserpp/multi_tensor_model.py:MultiTensorDenoiser",
        ),
        _entry(
            "scene_tensors",
            ...
            "Joint agent and traffic-light scene tensors.",
            "matched",
            "src/scenediffuserpp/normalization.py",
            "src/scenediffuserpp/multi_tensor_model.py:DenoiserOutput",
        ),
        _entry(
        ...
        _entry(
            ...
            "matched",
            "src/scenediffuserpp/scene_builder.py:SceneWindow",
            "src/scenediffuserpp/storage.py:reference_world_pose",
        ),
        _entry(
            ...
            "interpreted",
            "src/scenediffuserpp/roadgraph.py",
            "src/scenediffuserpp/storage.py:_map_tensors",
            "src/scenediffuserpp/context_encoder.py:RoadgraphEncoder",
        ),
        _entry(
            "sparse_loss",
            ...
            "interpreted",
            "src/scenediffuserpp/diffusion.py:sparse_v_loss",
        ...
        _entry(
            ...
            "src/scenediffuserpp/masks.py:mixed_multitensor_training_masks",
        ),
        _entry(
            "control_mask",
            "Training",
            ...
            "interpreted",
            "src/scenediffuserpp/masks.py:_sample_factorized_control",
        ),
        _entry(
            "optimizer",
            "Training",
            ...
            "interpreted",
            "src/scenediffuserpp/trainer.py:build_optimizer",
        ...
        _entry(
            ...
            "missing",
            "src/scenediffuserpp/trainer.py:ExponentialMovingAverage",
        ...
        _entry(
            ...
            "matched",
            "src/scenediffuserpp/sampler.py:paper_denoise",
            "src/scenediffuserpp/sampler.py:paper_renoise",
        ...
        _entry(
            ...
            "interpreted",
            "src/scenediffuserpp/trainer.py:train_step",
            "src/scenediffuserpp/sampler.py:sampling_time_grid",
        ...
        _entry(
            ...
            "interpreted",
            "src/scenediffuserpp/sampler.py:soft_clip_sparse",
        ...
        _entry(
            ...
            "missing",
            "src/scenediffuserpp/short_evaluation.py",
        ...
        _entry(
            ...
            "reduced_scale",
            "src/scenediffuserpp/denoising_evaluation.py",
        ...
        _entry(
            ...
            "missing",
            "src/scenediffuserpp/audit.py:_check_configured_corpus",
            "src/scenediffuserpp/audit.py:_check_teacher_manifests",
            "src/scenediffuserpp/storage.py:assign_split",
            "docs/scenediffuserpp-nanjing-reproduction-status.md",
        ),
        _entry(
